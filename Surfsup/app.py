...
def welcome():
    ...
    #list all routes 
    return '''Welcome to the Hawaii Weather API. Here, you will be able to access precipitation,temperature(tobs) data, and 
    the weather stations used to collect data. Enter in a date range and the API will return the average, minimum and maximum temperature in that date range.<br/>
